...
View.OnClickListener Recover_Listener=new View.OnClickListener() {
    ...
    public void onClick(View v) {
        ...
        url_string="http://192.168.43.127/android/android_recover.php?username="+username+"&current_hint="+curr_hint+"&password1="+password1+"&password2="+password2+"&hint1="+hint1+"&hint2="+hint2;
