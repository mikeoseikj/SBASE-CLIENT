...
public class ChangeCredentialsActivity extends AppCompatActivity {
    ...
    View.OnClickListener Change_Listener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            url_string = "http://" + NetworkUtility.MY_IP_ADDRESS + "/android/android_change.php?username=" + username + "&current_password=" + current_password + "&password1=" + password1 + "&password2=" + password2 + "&hint1=" + hint1 + "&hint2=" + hint2;
